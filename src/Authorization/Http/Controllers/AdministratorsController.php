...
use Arcanesoft\Foundation\Authorization\Repositories\{AdministratorsRepository, RolesRepository};
...
class AdministratorsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->setCurrentSidebarItem('foundation::authorization.administrators');

        $this->addBreadcrumbParent();
        $this->addBreadcrumbRoute(__('Administrators'), 'admin::authorization.administrators.index');
    }
    ...
    public function metrics()
    {
        ...
        $this->addBreadcrumbRoute(__('Metrics'), 'admin::authorization.administrators.metrics');
     ...
     *
     * @param  \Arcanesoft\Foundation\Authorization\Http\Requests\Administrators\CreateAdministratorRequest  $request
    ...
    public function store(CreateAdministratorRequest $request, AdministratorsRepository $repo)
    {
        ...
        return redirect()->route('admin::authorization.administrators.show', [$admin]);
    }
    ...
    public function show(Administrator $administrator)
    {
        ...
        $this->addBreadcrumbRoute(
            ...
            'admin::authorization.administrators.show', [$administrator]
        );
     ...
     *
     * @param  \Arcanesoft\Foundation\Authorization\Models\Administrator                                     $administrator
     * @param  \Arcanesoft\Foundation\Authorization\Http\Requests\Administrators\UpdateAdministratorRequest  $request
     * @param  \Arcanesoft\Foundation\Authorization\Repositories\AdministratorsRepository                    $repo
     *
     * @return \Illuminate\Http\RedirectResponse
     */
    public function update(Administrator $administrator, UpdateAdministratorRequest $request, AdministratorsRepository $repo)
    {
        ...
        return redirect()->route('admin::authorization.administrators.show', [$administrator]);
    }
