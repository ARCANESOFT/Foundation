 ...
 */
class SocialiteUsersRepository extends Repository
{
    /* -----------------------------------------------------------------
     |  Main Methods
     | -----------------------------------------------------------------
    ...
    public function findOrCreateUser(string $provider)
    {
        ...
        /** @var  \Arcanesoft\Foundation\Authorization\Models\User|null  $user */
     ...
     *
     * @return \Arcanesoft\Foundation\Authorization\Repositories\UsersRepository|mixed
     */
