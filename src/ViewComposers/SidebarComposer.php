...
class SidebarComposer
{
    ...
    public function compose(View $view)
    {
        ...
        $this->sidebar->add([
            ...
            'children'    => [
                [
                    'title'       => 'Statistics',
                    'name'        => 'auth-dashboard',
                    'url'         => route('auth::foundation.dashboard'),
                    ...
                    'title'       => 'Users',
                    'name'        => 'auth-users',
                    'url'         => route('auth::foundation.users.index'),
                    ...
                    'title'       => 'Roles',
                    'name'        => 'auth-roles',
                    'url'         => route('auth::foundation.roles.index'),
                    ...
                    'url'         => route('auth::foundation.permissions.index'),
        ...
        $this->sidebar->add([
            ...
            'url'         => route('foundation::log-viewer.index'),
