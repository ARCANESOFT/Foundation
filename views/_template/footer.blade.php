<footer class="main-footer py-3 mt-3 d-sm-flex justify-content-center justify-content-sm-between">
    <div class="container-fluid">
        <span class="small text-center text-sm-left d-block d-sm-inline-block">
