import {Action, MethodAction, ModelAction} from './Actions'
import ComponentPayload from './Types/ComponentPayload'
import {Directive, DirectiveExtractor, QuerySelector} from '../DOM'
...
export default class Component {
    ...
    private emitActionEvent(action: Action|any): void {
        window['Foundation'].$emit(COMPONENT_ACTION_EVENT, {
            component: this,
